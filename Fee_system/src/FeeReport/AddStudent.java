...
public class AddStudent extends JFrame implements ActionListener
{
    ...
    {
        int roll = Integer.parseInt(tf12.getText());
        String name = tf1.getText();
        String email = tf2.getText();
        String course = tf3.getText();
        float fee = Float.parseFloat(tf4.getText());
        float paid = Float.parseFloat(tf5.getText());
        String d=Float.toString(fee-paid);
        tf6.setText(d); //String due =Float.parseFloat(tf6.getText());
        ...
        if(e.getSource()==bt1)
        {
            try{
                ...
                String q="insert into add_student(rollno,name,email,course,fee,paid,due,address,city,state,country,mobile) values('"+roll+"','"+name+"','"+email+"','"+course+"','"+fee+"','"+paid+"','"+d+"','"+address+"','"+city+"','"+state+"','"+country+"','"+con+"')";
                ...
                if(aa==1){
                    ...
                    JOptionPane.showMessageDialog(null, "Your data was not inserted. Please fill all details carefully");
                    this.setVisible(false);
